...
def send_simple_message(to, subject, body):
    return requests.post(
        "https://api.mailgun.net/v3/sandboxcae7b31bac684ac79e0fe19be12b6f49.mailgun.org/messages",
        auth=("api", "5cc44e85020ef75c8587191d4b06deb5-2fbe671d-a17bff9d"),
        data={"from": "Mailgun Sandbox <postmaster@sandboxcae7b31bac684ac79e0fe19be12b6f49.mailgun.org>",
              "to": to,
              "subject": subject,
              "html": body})
